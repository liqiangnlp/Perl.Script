...
my @files   = ( 'c.input.txt' );
my @folders = ( 'G:\MY-WORK\scripts\deal.with.dictionary\Dictionary\NEUNLP-C2E-PROPER-NOUN-DICT\BASIC-dict\ldc_ce_dict',
                'G:\MY-WORK\scripts\deal.with.dictionary\Dictionary\NEUNLP-C2E-PROPER-NOUN-DICT\BASIC-dict\ldc_ec_dict');
