...
#   Date      : 06/16/2011
#   last Modified by :
#     2012/08/23 Bug fixes.
#     2011/07/16 add deal with OOV function by Qiang Li
#     2011/07/16 first change "&" with "&amp;" by Qiang Li
#######################################
...
my $logo =   "########### SCRIPT ########### SCRIPT ############ SCRIPT ##########\n".
             "#                                                                  #\n".
             "#   NiuTrans Generate XML (version 1.1.0 Beta)  --www.nlplab.com   #\n".
             "#                                                                  #\n".
...
#	print STDERR "splitLineNum=$splitLineNum\n";
    my @ref;
