...
#######################################
#   version      : 1.1.0 Beta
#   Function     : Translation Model Chinese Character Segmentation
#   Author       : Qiang Li
...
my $logo =   "########### SCRIPT ########### SCRIPT ############ SCRIPT ##########\n".
             "#                                                                  #\n".
             "# NiuTrans Trans.Model Chn Char Seg(v1.1.0 Beta)  --www.nlplab.com #\n".
             "#                                                                  #\n".
...
while( <INFILE> )
{
          ...
          if( /(.*?) \|\|\| (.*?) \|\|\| (.*)/ )
		  {
			  ...
			  {
						$sentence = decode( "gb2312", $2 );
			  }
			  elsif( $param{ "-inEncode" } eq "UTF-8" )
			  {
						$sentence = decode( "UTF-8", $2 );
			  }
			  ...
			  {
						print OUTFILE encode ( "gb2312", $src." \|\|\| ".$sentenceAfterSeg." \|\|\| ".$other ), "\n";
			  }
			  elsif( $param{ "-outEncode" } eq "UTF-8" )
			  {
						print OUTFILE $src." \|\|\| ".$sentenceAfterSeg." \|\|\| ".$other, "\n";
			  }
		  }
...
sub getParameter
{
          ...
          {
                    print STDERR "[USAGE]    :\n".
                                 "        NiuTrans-Trans.Model.Chn.Char.Seg.pl        [OPTIONS]\n".
                                 "[OPTION]   :\n".
                                 "          -in          :  Inputted  File.\n".
                                 "          -out         :  Outputted File.\n".
                                 ...
                                 "                            Value is 'UTF-8', 'gb2312'.\n".
                                 "[EXAMPLE]  :\n".
                                 "        perl NiuTrans-Trans.Model.Chn.Char.Seg.pl\n".
                                 "                                                  [-in  FILE]\n".
                                 "                                                  [-out FILE]\n";
                    exit( 0 );
          }
