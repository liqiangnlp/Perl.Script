...
#######################################
#   version      : 1.1.0 Beta
#   Function     : Development Set Chinese Character Segmentation
#   Author       : Qiang Li
...
my $logo =   "########### SCRIPT ########### SCRIPT ############ SCRIPT ##########\n".
             "#                                                                  #\n".
             "#  NiuTrans Dev.Set Chn Char Seg (v1.1.0 Beta)   --www.nlplab.com  #\n".
             "#                                                                  #\n".
...
while( <INFILE> )
{
          ...
          if( $lineNo % $splitSeg == 1 or $lineNo % $splitSeg == 2 )
          {
		      if( $param{ "-outEncode" } eq "gb2312" )
			  {
						print OUTFILE encode ( "gb2312", $sentence ), "\n";
			  }
		  ...
		  else
		  {
			  ...
			  foreach $word ( @chineseChar )
			  {
						...
						{
							if( $lastChar =~ /[[:ascii:]]/ and $character =~ /[[:ascii:]]/ )
							{
...
sub getParameter
{
          if( ( scalar( @_ ) < 4 ) || ( scalar( @_ ) % 2 != 0 ) )
          {
                    print STDERR "[USAGE]    :\n".
                                 ...
                                 "                            Default value is 'gb2312'.\n".
                                 "                            Value is 'UTF-8', 'gb2312'.\n".
                                 "          -rnum        :  Reference Number.        [optional]\n".
                                 "                            Default value is '4'.\n".
                                 "[EXAMPLE]  :\n".
