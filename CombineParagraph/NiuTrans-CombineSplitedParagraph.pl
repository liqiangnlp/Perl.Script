...
#######################################
#   version      : 1.1.0
#   Function     : Combine Splited Paragraph
#   Author       : Qiang Li
...
#		  }
          ...
          if( $_ eq "" and $paragraph ne "" )
		  {
		      $paragraph =~ s/^ +//g;
			  $paragraph =~ s/ +$//g;
			  $paragraph =~ s/ +/ /g;
		      print OUTFILE $paragraph."\n";
			  
#			  print STDERR $paragraph."\n";
			  
			  $paragraph = "";
		  }
		  elsif( $_ eq "" and $paragraph eq "" )
		  {
		      print OUTFILE "\n";
		  }
		  else
...
sub getParameter
{
          ...
          {
                    print STDERR "[USAGE]\n".
                                 "     CombineSplitedParagraph.pl        [OPTIONS]\n".
                                 "[OPTION]\n".
                                 "            -in  :  Inputted File.\n".
                                 "            -out :  Outputted File.\n".
                                 "[EXAMPLE]\n".
                                 "     perl CombineSplitedParagraph.pl   [-in  FILE]\n".
                                 "                                       [-out FILE]\n";
                    exit( 0 );
          }
