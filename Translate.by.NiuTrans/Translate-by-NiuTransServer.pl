...
#		  print STDERR "$_[ 1 ]\n";
          ...
          my $url = "http://202.118.18.202:8080/NiuTransServer/translate?input=$srcSentence&type=news&sub=Translate+%3E%3E&output=&hidden=noreset&paras=&from=chinese";
